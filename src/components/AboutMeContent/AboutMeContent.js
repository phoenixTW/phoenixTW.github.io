        ...
        <div className="about-me-content__wrapper">
            ...
            <div className="about-me-content__container">
                ...
                <p>
                    ...
                    as a <a className="thoughtworks__design" href="https://thoughtworks.com/STEP">STEP</a> intern in 2014, and as a Consultant on 2016, where I got opportunity to work with various clients, world wide while solving different problems with various technologies.
                </p>
                <p>
